# Web UI Encyclopedia Sport Cars 🏎️
...
- Use the sidebar navigation to select a year and explore the corresponding Porsche sports cars.
- Enable dark mode for a more pleasant visual experience. 🌙
